...
mkdir -p /home/ubuntu/lec_project/server/pagina-oficial
mkdir -p /home/ubuntu/lec_project/server/panel-control
mkdir -p /home/ubuntu/lec_project/server/files
cd /home/ubuntu/lec_project/server
...
# === CREAR DOCKER-COMPOSE CON RUTAS ACTUALIZADAS ===
...
services:
  pagina-oficial:
    ...
    volumes:
      - /home/ubuntu/lec_project/server/pagina-oficial:/usr/share/nginx/html
    ports:
      - "8082:80"
    networks:
      - web-net
  ...
  panel-control:
    ...
    volumes:
      - /home/ubuntu/lec_project/server/panel-control:/usr/share/nginx/html
    ports:
      - "8083:80"
    networks:
      - web-net
...
# === LIMPIAR CONTENEDORES, RED Y VOLÚMENES ANTERIORES ===
echo "==> Eliminando configuración antigua si existe..."
docker compose down --volumes --remove-orphans || true
docker rm -f pagina-oficial panel-control filemanager postgres pgadmin portainer 2>/dev/null || true
docker volume rm $(docker volume ls -qf dangling=true) 2>/dev/null || true
docker network rm web-net 2>/dev/null || true
